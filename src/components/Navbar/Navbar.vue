...
function handleDropdownButton(dropdown) {
    ...
    <nav>
      ...
      >
        ...
        <div
          ...
          id="documentation-dropdown-content"
          class="dropdown-content"
          @click="handleDropdownButton(false)"
        >
          <div class="top">
...
header nav a.donate button.dropdown-button::after {
	...
	filter: brightness(0) invert(78%) sepia(2%) saturate(5488%) hue-rotate(197deg) brightness(88%) contrast(93%);
